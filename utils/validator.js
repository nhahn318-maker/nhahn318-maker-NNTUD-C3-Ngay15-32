...
module.exports = {
    ...
    ChangePasswordValidator: [
        ...
        body('newpassword').notEmpty().withMessage("newpassword khong duoc de trong").bail().isStrongPassword({
            ...
            minSymbols: 1,
            minUppercase: 1
        }).withMessage("newpassword phai co it nhat 8 ki tu trong do co it nhat 1 ki tu chu hoa, 1 ki tu chu thuong,1 ki tu so va 1 ki tu dac biet").bail()
            .custom((value, { req }) => value !== req.body.oldpassword)
            .withMessage("newpassword khong duoc trung voi oldpassword"),
    ],
